...
// Lucide dropped brand icons in v1, so the GitHub and LinkedIn marks live here
// as local copies of the v0 paths (ISC) to keep the stroke style consistent
// with the lucide icons they sit next to.
