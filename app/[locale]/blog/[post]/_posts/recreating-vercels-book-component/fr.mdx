...
Le composant accepte des propriétés pour la couleur de couverture du livre, le titre, la texture, et diverses options de style, maintenant la même API propre qui rend les composants Geist si agréables à utiliser.
