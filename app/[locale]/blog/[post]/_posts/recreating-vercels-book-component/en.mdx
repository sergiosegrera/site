...
The component accepts props for the book's cover color, title, texture, and various styling options, maintaining the same clean API that makes Geist components so pleasant to work with.
